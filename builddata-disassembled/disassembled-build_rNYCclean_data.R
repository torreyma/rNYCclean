...
####################################################################
# This first section just sets up the variables according to the instructions on the bottom of the README
...
my_dir <- "~/address_cleaning/datasets"
...
#build_rNYCclean_data(my_version,my_dir,my_cores,as_rdb=FALSE) # as_rdb is the key option here
